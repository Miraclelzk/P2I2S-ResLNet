...
class OptInit:
    def __init__(self):
        ...
        # ----------------- Dataset related
        parser.add_argument('--data_name', type=str, default='modelnet',
                            help="dataset")
        parser.add_argument('--data_dir', type=str, default='/opt/data/common/modelnet40',
        ...
        # ----------------- SNN 
        parser.add_argument('--T', type=int, default=2, metavar='T',
                            help='T (default:4))')
        ...
        # self.args.data_name = "modelnet"
        # self.args.data_dir = "/opt/data/common/modelnet40"
        # self.args.num_points = 2048
        # self.args.n_classes = 40

        # self.args.data_name = "scanobjectnn"
        # self.args.data_dir = "/opt/data/common/SNN/p2p/ScanObjectNN/main_split/"
        # self.args.num_points = 2048
        # self.args.n_classes = 15
