...
@register_model
def spiking_resnet18(pretrained=False, **kwargs):
    """
    ...
    model = _spiking_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, spiking_neuron, **kwargs1)
    return model
...
def spiking_resnet34(pretrained=False, progress=True, spiking_neuron: callable=None, **kwargs):
    ...
    kwargs1['detach_reset'] = True
    kwargs1['surrogate_function'] = surrogate.ATan()
    return _spiking_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress, spiking_neuron, **kwargs1)
...
def spiking_resnet50(pretrained=False, progress=True, spiking_neuron: callable=None, **kwargs):
    ...
    kwargs1['detach_reset'] = True
    kwargs1['surrogate_function'] = surrogate.ATan()
    return _spiking_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, spiking_neuron, **kwargs1)
